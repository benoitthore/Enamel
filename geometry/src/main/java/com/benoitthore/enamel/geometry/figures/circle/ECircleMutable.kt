...
interface ECircleMutable : ECircle, CanSetBounds<ECircle, ECircleMutable>,
    EShapeMutable<ECircle, ECircleMutable> {
    override var radius: Float
    override val center: EPointMutable
}

fun <T : ECircleMutable> T.set(other: ECircle) = set(other.center.x, other.center.y, other.radius)
fun <T : ECircleMutable> T.set(center: EPoint = this.center, radius: Number = this.radius) =
    set(center.x, center.y, radius)

fun <T : ECircleMutable> T.set(
    x: Number = centerX,
    y: Number = centerY,
