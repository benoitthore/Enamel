...
//interface ERectGroup : EShapeMutable<ERectGroup, ERectGroup> {
//    val frame: ERectMutable
//    val rects: List<EShape<*, *>>
//
//    override fun _copy(): ERectGroup = rects.toRectGroup()
//
//    override fun toMutable(): ERectGroupMutable = _copy()
//
//    override fun toImmutable(): ERectGroup = _copy()
//
//    override fun set(other: ERectGroup): ERectGroupMutable = TODO()
//
...
//    }
//
//    class ERectGroupImpl(override val rects: List<EShapeMutable<*, *>>) : ERectGroup {
//
//        private val _frame = MutableRect()
//
//
//        override val frame: ERectMutable
//            get() = _frame
//
//        init {
//            updateFrame()
