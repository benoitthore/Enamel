...
object ML4J_test {
    ...
    fun List<LabeledDataOLD>.toDataSetIterator(batch: Int = 10): DataSetIterator {
...
//            .learningRate(0.1)
        ...
        val truthTable = listOf(
            LabeledDataOLD(listOf(1f, 0f), 1, labels),
            LabeledDataOLD(listOf(0f, 1f), 1, labels),
            LabeledDataOLD(listOf(1f, 1f), 0, labels),
            LabeledDataOLD(listOf(0f, 0f), 0, labels)
        )
